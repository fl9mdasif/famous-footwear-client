...
const ServiceCard = () => {
    return (
        <div className=" flex justify-center  flex-wrap  ">
            {/* cards  */}
            <div class="card lg:w-64 mb-3 sm:mr-5 md:w-80  sm:w-80 bg-base-100 shadow-xl">
                <div class="card-body  ">
                    <div class="flex ">
